...
import pl.a2s.ms.core.obj.Griewank;
...
public class GriewankOC extends BenchmarkOrchestratorConfigurer {
    ...
    protected void doConfigure(BenchmarkEnabledOrchestrator orch) {
        final Griewank griewank = new Griewank();
        final IndividualEvaluator ie = new IndividualEvaluator(griewank);
        orch.setObjectiveCalculator(griewank);
        orch.setIndividualEvaluator(ie);
        orch.setAnalyser(new MinimaInfoAnalyser(griewank, ie));
