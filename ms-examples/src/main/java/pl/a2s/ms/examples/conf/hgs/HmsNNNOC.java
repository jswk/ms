...
import pl.a2s.ms.core.sprout.reducer.DominatingOnlySproutReducer;
...
public class HmsNNNOC extends HgsOrchestratorConfigurer {

    private static final String CONFIG_ID = "nnn";
    ...
    protected void doConfigure(HgsOrchestrator orch) {
        ...
        state.setPopulationSizes(new int[] { 64, 20, 10 });
        state.setGlobalStopCondition(new EvaluationCountGSC(10000, orch.individualEvaluator));
        ...
        final EvoAlg[] eas = new EvoAlg[] {
                ...
                new NSGA2(0.8, 0.5, stds[1] / dimMultiplier, orch.individualEvaluator, orch.rand, orch.fitnessExtractor),
                new NSGA2(0.9, 0.5, stds[2] / dimMultiplier, orch.individualEvaluator, orch.rand, orch.fitnessExtractor)
        };
        ...
        final Sprouter[] sprouters = new Sprouter[] {
                new BasicSprouter(0, stds[1] / dimMultiplier, state.getPopulationSizes()[1], orch.rand),
                new BasicSprouter(0, stds[2] / dimMultiplier, state.getPopulationSizes()[2], orch.rand),
                new NoSprouter()
        };
        final SproutReducer[] sproutReducers = new SproutReducer[] {
                new ChainedSproutReducer(
                        new DominatingOnlySproutReducer(orch.individualEvaluator),
