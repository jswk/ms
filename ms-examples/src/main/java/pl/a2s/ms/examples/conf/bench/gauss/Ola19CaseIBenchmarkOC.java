...
import lombok.val;
import pl.a2s.ms.examples.analysis.Ola19CaseIAnalyser;
...
public class Ola19CaseIBenchmarkOC extends BenchmarkOrchestratorConfigurer {
    ...
    protected void doConfigure(BenchmarkEnabledOrchestrator orch) {
        ...
        val analyser = new Ola19CaseIAnalyser();
        orch.setAnalyser(analyser);
    }

    protected Range[] getDomain(int dim) {
        return ArraysUtil.constant(new Range(0., 6.), new Range[dim]);
    }
}
