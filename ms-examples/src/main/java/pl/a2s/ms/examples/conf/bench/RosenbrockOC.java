...
import pl.a2s.ms.core.obj.Rosenbrock;
...
public class RosenbrockOC extends BenchmarkOrchestratorConfigurer {
    ...
    protected void doConfigure(BenchmarkEnabledOrchestrator orch) {
        ...
        final IndividualEvaluator ie = new IndividualEvaluator(rosenbrock);
        orch.setObjectiveCalculator(rosenbrock);
        orch.setIndividualEvaluator(ie);
        orch.setAnalyser(new MinimaInfoAnalyser(rosenbrock, ie));
