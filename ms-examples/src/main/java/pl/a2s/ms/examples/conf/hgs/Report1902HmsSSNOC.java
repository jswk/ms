...
public class Report1902HmsSSNOC extends Report1902AbstractOC {
    ...
    protected EvoAlg[] getEAs(double[] stds, double dimMultiplier, HgsOrchestrator orch) {
        return new EvoAlg[] {
                ...
                new NSGA2(0.5, 0.1, stds[2] / dimMultiplier, orch.getIndividualEvaluator(), orch.rand, orch.getFitnessExtractor())
        };
    }
