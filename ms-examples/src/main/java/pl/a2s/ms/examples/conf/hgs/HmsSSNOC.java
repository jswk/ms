...
public class HmsSSNOC extends HgsOrchestratorConfigurer {

    public static final String CONFIG_ID = "ssn";
    ...
    protected void doConfigure(HgsOrchestrator orch) {
        ...
        final double[] stds = new double[] { 3.0, 1.0, 0.1 };
        final EvoAlg[] eas = new EvoAlg[] {
                ...
                new NSGA2(0.5, 0.1, stds[2] / dimMultiplier,
                        orch.individualEvaluator,
                        orch.rand,
                        orch.getFitnessExtractor()
                        )
        };
